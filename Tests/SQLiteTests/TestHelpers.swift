...
class SQLiteTestCase: XCTestCase {
    ...
    @discardableResult func insertUser(_ name: String, age: Int? = nil, admin: Bool = false) throws -> SQLiteStatement {
    ...
    func assertSQL(_ SQL: String, _ statement: SQLiteStatement, _ message: String? = nil, file: StaticString = #file, line: UInt = #line) {
        try! statement.run()
